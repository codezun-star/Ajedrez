...
const TIER_RING: Record<Achievement['tier'], string> = {
  ...
  platinum: 'ring-brand-300/60 shadow-[0_0_24px_-6px_rgba(231,68,69,0.8)]',
};
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
      {ALL_ACHIEVEMENTS.map((a, i) => {
        ...
        const text = achievementText(locale, a.id);
        return (
          <motion.div
            key={a.id}
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <div className="truncate text-[0.7rem] text-slate-400">{text.desc}</div>
            </div>
          </motion.div>
        );
      })}
